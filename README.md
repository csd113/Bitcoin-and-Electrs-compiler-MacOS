...
```
git clone https://github.com/csd113/Bitcoin-And-Electrs-GUI-Compiler-For-MacOS.git && cd Bitcoin-And-Electrs-GUI-Compiler-For-MacOS && chmod +x build.sh && ./build.sh
```
